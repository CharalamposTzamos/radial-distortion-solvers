...
struct CameraPose 
{
    ...
    CameraPose() : q(1.0, 0.0, 0.0, 0.0), t(0.0, 0.0, 0.0), focal_length(1.0) {}
...
struct ThreeViewCameraPose { //struct alignas(32)
...
// Three view relative pose refinement. Minimizes Sampson error error. Assumes identity intrinsics (calibrated camera)
